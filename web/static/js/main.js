...
var _user$project$Component_Model$appModel = {
...
var _user$project$Component_Model$MyTask = F4(
	function (a, b, c, d) {
		return {id: a, title: b, reference: c, dateDelivery: d};
	});
var _user$project$Component_Model$User = F5(
	function (a, b, c, d, e) {
		return {username: a, password: b, name: c, lastname: d, email: e};
	});
var _user$project$Component_Model$AppModel = F4(
	function (a, b, c, d) {
		return {user: a, mdl: b, snackbar: c, tasks: d};
	});
var _user$project$Component_Model$Email = {ctor: 'Email'};
var _user$project$Component_Model$Lastname = {ctor: 'Lastname'};
var _user$project$Component_Model$Name = {ctor: 'Name'};
var _user$project$Component_Model$Password = {ctor: 'Password'};
var _user$project$Component_Model$Username = {ctor: 'Username'};
var _user$project$Component_Model$Snackbar = function (a) {
	return {ctor: 'Snackbar', _0: a};
};
var _user$project$Component_Model$CreateUser = {ctor: 'CreateUser'};
var _user$project$Component_Model$UpdateSucceed = function (a) {
	return {ctor: 'UpdateSucceed', _0: a};
};
var _user$project$Component_Model$UpdateFail = function (a) {
	return {ctor: 'UpdateFail', _0: a};
};
var _user$project$Component_Model$LoadTask = {ctor: 'LoadTask'};
var _user$project$Component_Model$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$Component_Model$FetchTasksSucceed = function (a) {
	return {ctor: 'FetchTasksSucceed', _0: a};
};
var _user$project$Component_Model$UpdateUser = F2(
	function (a, b) {
		return {ctor: 'UpdateUser', _0: a, _1: b};
	});
var _user$project$Component_Model$MDL = function (a) {
	return {ctor: 'MDL', _0: a};
};

var _user$project$Component_API$errorsDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['errors']),
	_elm_lang$core$Json_Decode$dict(
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$Component_API$encodeUser = function (user) {
...
var _user$project$Component_API$createUser = function (user) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Component_Model$UpdateFail,
		_user$project$Component_Model$UpdateSucceed,
		A3(
			_lukewestby$elm_http_builder$HttpBuilder$send,
			_lukewestby$elm_http_builder$HttpBuilder$stringReader,
			_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_user$project$Component_API$errorsDecoder),
				...
				A2(
					...
					A3(
						...
						A2(
							...
							_user$project$Component_API$encodeUser(user),
							_lukewestby$elm_http_builder$HttpBuilder$post('http://localhost:4000/api/users')))))));
};
var _user$project$Component_API$decodeTasks = function () {
	var task = A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$Component_Model$MyTask),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'reference', _elm_lang$core$Json_Decode$string)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'dateDelivery', _elm_community$json_extra$Json_Decode_Extra$date));
	return A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['data']),
		_elm_lang$core$Json_Decode$list(task));
}();
var _user$project$Component_API$getTasks = A3(
	_elm_lang$core$Task$perform,
	_user$project$Component_Model$FetchFail,
	_user$project$Component_Model$FetchTasksSucceed,
	A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_user$project$Component_API$decodeTasks),
		_lukewestby$elm_http_builder$HttpBuilder$stringReader,
		_lukewestby$elm_http_builder$HttpBuilder$withCredentials(
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withTimeout,
				...
				A3(
					...
					'Content-Type',
					'application/json',
					_lukewestby$elm_http_builder$HttpBuilder$get('http://localhost:4000/api/tasks'))))));

var _user$project$Component_Update$notify = F3(
	function (tag, value, _p0) {
		var _p1 = _p0;
		var _p4 = _p1._0;
		var _p2 = A2(
		...
		var snackbar = _p2._0;
		var snackCmd = _p2._1;
		var _p3 = A2(_elm_lang$core$Debug$log, tag, value);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				_p4,
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_p1._1,
						A2(_elm_lang$core$Platform_Cmd$map, _user$project$Component_Model$Snackbar, snackCmd)
					]))
		};
	});
var _user$project$Component_Update$updateUser = F3(
	function (model, msg, input) {
		var user = model.user;
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'Username':
...
var _user$project$Component_Update$update = F2(
	function (msg, model) {
		var _p6 = A2(_elm_lang$core$Debug$log, 'cas', msg);
		switch (_p6.ctor) {
			case 'MDL':
			...
			case 'UpdateUser':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Component_Update$updateUser, model, _p6._0, _p6._1),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoadTask':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Component_API$getTasks};
			case 'FetchTasksSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'FetchFail':
				return A3(
					_user$project$Component_Update$notify,
					'errors',
					_p6._0,
					A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'UpdateFail':
				...
				if (_p7.ctor === 'BadResponse') {
					...
					return A3(
						_user$project$Component_Update$notify,
						'errors',
						'Can\'t cmmunicate with the server',
						A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							_elm_lang$core$Native_List.fromArray(
			...
			case 'CreateUser':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Component_API$createUser(model.user)
				};
			default:
				var _p8 = A2(_debois$elm_mdl$Material_Snackbar$update, _p6._0, model.snackbar);
				var snackbar = _p8._0;
				var snackCmd = _p8._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$View_View$taskItem = function (task) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html$text(task.title),
						_elm_lang$html$Html$text(task.reference)
					]))
			]));
};
var _user$project$View_View$userform = function (model) {
	return A2(
		...
		A2(
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_debois$elm_mdl$Material_Grid$size, _debois$elm_mdl$Material_Grid$Phone, 2),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Component_Model$MDL,
					_elm_lang$core$Native_List.fromArray(
						[0]),
					model.mdl,
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Textfield$label('Username'),
							_debois$elm_mdl$Material_Textfield$floatingLabel,
							_debois$elm_mdl$Material_Textfield$value(model.user.username),
							_debois$elm_mdl$Material_Textfield$onInput(
							_user$project$Component_Model$UpdateUser(_user$project$Component_Model$Username)),
							_debois$elm_mdl$Material_Textfield$maxlength(15)
						])),
					A4(
					_debois$elm_mdl$Material_Textfield$render,
					_user$project$Component_Model$MDL,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Textfield$label('Password'),
							_debois$elm_mdl$Material_Textfield$floatingLabel,
							_debois$elm_mdl$Material_Textfield$onInput(
							_user$project$Component_Model$UpdateUser(_user$project$Component_Model$Password)),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Textfield$label('Name'),
							_debois$elm_mdl$Material_Textfield$floatingLabel,
							_debois$elm_mdl$Material_Textfield$value(model.user.name),
							_debois$elm_mdl$Material_Textfield$onInput(
							_user$project$Component_Model$UpdateUser(_user$project$Component_Model$Name)),
							_debois$elm_mdl$Material_Textfield$maxlength(15)
						])),
					A4(
					_debois$elm_mdl$Material_Textfield$render,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Textfield$label('Last name'),
							_debois$elm_mdl$Material_Textfield$floatingLabel,
							_debois$elm_mdl$Material_Textfield$value(model.user.lastname),
							_debois$elm_mdl$Material_Textfield$onInput(
							_user$project$Component_Model$UpdateUser(_user$project$Component_Model$Lastname)),
							_debois$elm_mdl$Material_Textfield$maxlength(15)
						])),
					A4(
					_debois$elm_mdl$Material_Textfield$render,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Textfield$label('Email'),
							_debois$elm_mdl$Material_Textfield$floatingLabel,
							_debois$elm_mdl$Material_Textfield$value(model.user.email),
							_debois$elm_mdl$Material_Textfield$onInput(
							_user$project$Component_Model$UpdateUser(_user$project$Component_Model$Email))
						])),
					A5(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_debois$elm_mdl$Material_Button$onClick(_user$project$Component_Model$CreateUser)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _user$project$View_View$body = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View_View$userform(model)
					])),
				A2(
				_debois$elm_mdl$Material_Grid$grid,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[]),
								A2(_elm_lang$core$List$map, _user$project$View_View$taskItem, model.tasks))
							]))
					]))
			]));
};
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$Component_Model$Snackbar,
								_debois$elm_mdl$Material_Snackbar$view(model.snackbar)),
								_user$project$View_View$body(model)
							]))
					])
			}));
};
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material$subscriptions, _user$project$Component_Model$MDL, model);
};
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Component_Model$appModel, _1: _user$project$Component_API$getTasks},
			view: _user$project$View_View$view,
			subscriptions: _user$project$Main$subscriptions,
			update: _user$project$Component_Update$update
		})
};
